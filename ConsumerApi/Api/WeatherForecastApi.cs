    ...
    public class WeatherForecastApi : IWeatherForecastApi
    {
        ...
        public List<WeatherForecast> WeatherForecastGet()
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException((int)response.StatusCode, "Error calling WeatherForecastGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException((int)response.StatusCode, "Error calling WeatherForecastGet: " + response.ErrorMessage, response.ErrorMessage);
